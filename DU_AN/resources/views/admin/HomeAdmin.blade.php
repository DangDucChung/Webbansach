...
<body>
    ...
    <main>
        ...
        <div  >
            <a href="/addbook" class="btn btn-success">Thêm sản phẩm</a>
        </div>
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td> {{ $row->tinhtrang }}</td>
                    <td> {{ $row->gia }}.000₫</td>
                    <td style="text-align: center;"> <img style="width: 10%;text-align: center;" src="public/upload/{{ $row->hinhanh }}" alt=""> </td>
                    <td>

                        <a href="{{url('/updatebook',[$row->id])}}" class="btn btn-primary btn-block">Sửa</a>
                        <button class="btn btn-primary btn-block cart_remove" data-id_cart_remove="{{ $row->id }}"> <i class="fa fa-trash-o"></i>Xóa </button>
        ...
        console.log(product_id);
           ...
           $.ajax({
            method: "POST",// phương thức dữ liệu được truyền đi
				url: "/deletebook",// gọi đến file server show_data.php để xử lý
