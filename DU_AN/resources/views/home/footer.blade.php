...
<div style="margin-top: 50px;">
    <footer class="footer" style="background-color:#2E282E ;">
        <div style="color: white;">
            <div class=" row ">
                ...
                <div class="col-6">
                    ...
                    <div class="input-group">
                        <input style=" height:60px" aria-label="Địa chỉ Email" type="email" class="form-control" placeholder="Địa chỉ Email" name="EMAIL" required="" autocomplete="off">
                        <span class="input-group-append">
                            <button style="background-color: #03a9f4;height:60px" class="btn btn-default" type="submit" aria-label="Đăng ký nhận tin" name="subscribe">Đăng
                                ký</button>
                        </span>
                    </div>
            ...
            <div  class="row1">
                <div>
                    <img src="public/upload/logoweb.webp" alt="">
    ...
    <div style="background-color:#000000fa;padding: 10px;">
        <p style="text-align: center;">© Bản quyền thuộc về Nhà sách Tiến Thọ | Cung cấp bởi Sapo </p>
