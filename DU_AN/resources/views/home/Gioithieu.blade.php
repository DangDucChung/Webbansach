...
<body >
    ...
    <div class="title"><h3>TIỆN ÍCH - GIẢI TRÍ - KẾT NỐI </h3></div>
    <div class="content">
    ...
    <div class="list">
        ...
        <ul>
            <li><img style="width: 0.5cm;height: 0.5cm;" src="public/upload/caret-right-solid.svg" alt="">Cơ sở 1: 828 Đường Láng - Đống Đa - Hà Nội
                <p><img style="width:0.5cm;   height:0.5cm;" src="public/upload/square-phone-solid.svg" alt=""> Hotline : 094.1234.828</p>
                
            </li>
            <li><img style="width: 0.5cm;height: 0.5cm;" src="public/upload/caret-right-solid.svg" alt="">Cơ sở 2: 36 Xuân Thủy - Cầu Giấy - Hà Nội
                <p><img style="width:0.5cm;   height:0.5cm;" src="public/upload/square-phone-solid.svg" alt="">Hotline: 093.417.3636</p>
            </li>
            <li><img style="width: 0.5cm;height: 0.5cm;" src="public/upload/caret-right-solid.svg" alt="">Cơ sở 3 : 424 Nguyễn Trãi - Thanh Xuân - Hà Nội
                <p><img style="width:0.5cm;   height:0.5cm;" src="public/upload/square-phone-solid.svg" alt="">Hotline: 0966 .688. 424</p>
            </li>
            <li><img style="width: 0.5cm;height: 0.5cm;" src="public/upload/caret-right-solid.svg" alt="">Cơ sở 4 : 697 Giải Phóng - Hoàng Mai - Hà Nội
                <p><img style="width:0.5cm;   height:0.5cm;" src="public/upload/square-phone-solid.svg" alt="">Hotline: 0933.695.697</p>
            </li>
            <li><img style="width: 0.5cm;height: 0.5cm;" src="public/upload/caret-right-solid.svg" alt="">Cơ sở 5 : 50 Nguyễn Thị Lưu - T.P Bắc Giang
                <p><img style="width:0.5cm;   height:0.5cm;" src="public/upload/square-phone-solid.svg" alt="">Hotline: 0948.555.050</p>
            </li>
            <li><img style="width: 0.5cm;height: 0.5cm;" src="public/upload/caret-right-solid.svg" alt="">Cơ sở 6 : 282a Lương Ngọc Quyến - Thái Nguyên
                <p><img style="width:0.5cm;   height:0.5cm;" src="public/upload/square-phone-solid.svg" alt="">Hotline: 0906.233.282</p>
            </li>
        </ul>
    </div>
    </div>
